...
### Tahap 5.1 — Validasi Notebook & Model

Validasi mencakup jumlah observasi, penanganan 4 nilai nol, NaN, index, ADF, split 75/33, alignment prediksi, windowing, dan kelengkapan metrik.

### Tahap 5.2 — Validasi CSV ↔ Notebook ↔ Dashboard

```text
Jumlah pemeriksaan : 45
Berhasil           : 45
Gagal              : 0
KESIMPULAN         : LULUS
```

Validasi memastikan jumlah baris CSV, nilai metrik, konfigurasi SARIMA, dan kebutuhan file dashboard konsisten.

### Tahap 5.3 — Pengujian Dashboard

Seluruh menu dashboard telah dijalankan secara lokal dan hasilnya telah dicross-check dengan notebook serta CSV final.
...
**MBKM Riset — Pemodelan Time Series dan Peramalan Kunjungan Wisatawan**
