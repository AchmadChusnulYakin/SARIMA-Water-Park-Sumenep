...
# =========================================================
st.set_page_config(
    page_title="SARIMA Forecast Dashboard | Water Park Sumenep",
    page_icon="📊",
    layout="wide",
...
st.sidebar.markdown(
    ...
    <div class='brand'>
        ...
        <div class='brand-subtitle'>Water Park Sumenep<br>Forecasting Dashboard</div>
    </div>
    """,
    unsafe_allow_html=True,
)
...
if menu == "Beranda":
    st.markdown(
        """
        <div class='hero'>
            <div class='hero-kicker'>MBKM Riset • Forecasting Time Series</div>
            <div class='hero-title'>Peramalan Kunjungan Wisatawan<br>Water Park Sumenep</div>
            <div class='hero-text'>
...
st.markdown(
    """
    <div class='footer'>
        <b>Dashboard SARIMA — Water Park Sumenep</b><br>
